      ...
      <div className="overflow-hidden relative w-full h-96 sm:h-80 md:h-full md:w-1/2 lg:w-1/2 flex-shrink-0">
        <div className="relative w-full h-full">
          <Image
            ...
            fill
            className={`object-cover transition-all duration-600 ease-in-out ${
          ...
          <div
            className={`absolute bottom-4 left-4 sm:bottom-6 sm:left-6 md:bottom-8 md:left-8 p-3 sm:p-4 w-[85%] sm:w-[75%] md:w-[70%] bg-white rounded-lg transition-all duration-600 ease-in-out ${
              isAnimating
        ...
        <div className="flex flex-col flex-1 p-4 sm:p-6 md:p-8 lg:pt-24 space-y-3 sm:space-y-8 md:space-y-0 md:justify-between overflow-y-auto">
          ...
          <div className="text-center flex-shrink-0">
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-600 font-sfPro px-2 sm:px-4 md:px-0">
              Choose your path to Web3 excellence and join our community of
              innovators.
            </p>
          </div>
          ...
          <div className="flex flex-col space-y-3 sm:space-y-8 md:space-y-6 lg:space-y-0 lg:flex-row lg:justify-between lg:items-end flex-shrink-0 md:pt-0 pt-8">
            ...
            <div className="w-full sm:w-auto lg:w-[165px] text-center lg:text-left px-4 sm:px-0">
              <h3 className="mb-2 text-lg sm:text-xl font-bold text-orange-500 font-sfPro">
                Our Mission
              </h3>
        ...
        <div className="fixed top-4 right-4 z-50 bg-white border border-gray-200 rounded-lg shadow-lg p-4 flex items-center gap-3 animate-in slide-in-from-right duration-300">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              Incubation program is under development
            </p>
          </div>
          <button
