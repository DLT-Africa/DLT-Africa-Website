  ...
  return (
    <div className="flex flex-col-reverse md:flex-row bg-[#F6F7F6] lg:gap-[30px] md:gap-[22.76px]  p-[30px] items-center justify-center ">
      <div className="lg:w-[448px] md:w-[369px] sm:w-[380px]  lg:mt-[150px] md:mt-[99px] mt-[40px]">
        <h2 className="text-[#1C1C1C] text-[30px] text-center lg:text-left lg:text-[48px] md:text-[36px] sm:text-[28px] leading-[120%] tracking-[1px] font-serif font-black">
          Change your career, <br/>
           <span className="text-[#FC7C13] lg:text-[48px] md:text-[36px] tracking-[1px] font-serif">
            change your life.
          </span>
        </h2>

        <p className="lg:w-[347px] md:w-[326px] mt-[15px] lg:text-[20px] md:text-[16px] font-serif text-[#1C1C1C] leading-[120%] text-opacity-[0.75]">
