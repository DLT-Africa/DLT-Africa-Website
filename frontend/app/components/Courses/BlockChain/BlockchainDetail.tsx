  ...
  },
  {
    ...
    answer: [
      <>
        <ul className="list-disc">
          <li>
            You should have a computer with an internet connection and have
            access to a Solidity development environment such as Remix or
            Truffle. Familiarity with Ethereum and the Ethereum Virtual Machine
            (EVM) is also recommended.
          </li>
          <li>
...
const BlockchainDetail: React.FC = () => {
  return (
