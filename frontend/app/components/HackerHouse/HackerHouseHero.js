      ...
      <div className="flex justify-between ">
        ...
        <div className="">
          <Image
            src={Group1}
            alt="Group 155"
            className=" lg:w-[60px] md:w-[29.5px] w-[14px] absolute top-[210px] left-[520px] hidden lg:block"
          />
          <Image
            src={Group2}
            alt=""
            className="  lg:w-[95px] md:w-[47px] w-[24] absolute top-[210px] left-[860px] hidden lg:block"
          />
          ...
          <div className="gap-[10px] sm:mt-[87px] mt-[87px] sm:gap-[25px] ">
            ...
            <div className=" mt-[25px]">
              <p1 className=" gap-[50px] text-[#F7FCFE] text-base md:text-[18px] lg:text-[20px] font-[400px] flex justify-center opacity-0.75  lg:mb-[20px] md:mb-[10px]">
                Date: mattis
                <div className=" mb-[15px] ">Location: mattismattis</div>
              </p1>
