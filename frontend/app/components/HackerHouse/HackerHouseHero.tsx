const HackerHouseHero: React.FC = () => {
  return (
    <div className="h-[640px]  bg-[#031700] flex justify-center items-center overflow-auto lg:w-full md:w-full w-[100%]  ">
      <div className="gap-[10px] sm:gap-[25px]  ">
        ...
        <div className=" mt-[25px]">
          <p className=" gap-[50px] text-[#F7FCFE] text-[18px] lg:text-[20px] font-[400px] flex justify-center opacity-0.75  lg:mb-[20px] md:mb-[10px]">
            Date: [in view]
